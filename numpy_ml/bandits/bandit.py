...
class MultiArmBanditMultinomialPayoff(Bandit):
    ...
    def __repr__(self):
        fstr = "MultiArmBanditMultinomialPayoff(payoffs={}, payoff_probs={})"
        return fstr.format(self.payoffs, self.payoff_probs)

    @property
    def hyperparameters(self):
        return {
            "id": "MultiArmBanditMultinomialPayoff",
...
class MultiArmBanditBernoulliPayoff(Bandit):
    ...
    def hyperparameters(self):
        return {
            "id": "MultiArmBanditBernoulliPayoff",
            "payoff_probs": self.payoff_probs,
        }
...
class MultiArmBanditGaussianPayoff(Bandit):
    def __init__(self, payoff_dists, payoff_probs):
        """
        A multi-armed bandit that is similar to
        :class:`MultiArmBanditBernoulliPayoff`, but instead of each arm having
    ...
    def hyperparameters(self):
        return {
            "id": "MultiArmBanditGaussianPayoff",
